export const Home = () => {
  return (
    <>
      ...
      <div className="max-w-[1150px] mx-auto bg-card border border-border shadow-sm rounded-2xl p-6">
        {/* Welcome Section */}
        <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="bg-muted/60 p-4 rounded-xl border border-border hover:shadow-md transition-shadow duration-300 ease-in-out">
